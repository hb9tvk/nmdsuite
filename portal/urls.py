...
urlpatterns = [
    ...
    path("report/picture/upload/", views.report_picture_upload, name="report_picture_upload"),
    path("report/picture/<int:idx>/delete/", views.report_picture_delete, name="report_picture_delete"),
